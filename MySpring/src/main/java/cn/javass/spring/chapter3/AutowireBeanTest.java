...
public class AutowireBeanTest {
    ...
    public void testAutowireByName2() throws IOException {
    	...
    	Map<String, cn.javass.spring.chapter3.bean.HelloApi> map = context.getBeansOfType(cn.javass.spring.chapter3.bean.HelloApi.class);
    ...
    @Test
    public void testAutowireByType1_1() throws IOException {
    	ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("chapter3/autowire-byType1.xml");
    	HelloApi helloApi2 = context.getBean("bean2", HelloApi.class);
    	helloApi2.sayHello();
    	System.out.println("====bean2----ok");
    ...
    @Test
    public void testAutowireByType2_4() throws IOException {
    	ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("chapter3/autowire-byType2-3.xml");
    	HelloApi helloApi2 = context.getBean("bean2", HelloApi.class);
    	helloApi2.sayHello();
    	System.out.println("====bean2----ok");
