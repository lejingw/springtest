...
import com.lejingw.apps.myspring3.annotation.bean.TestBean;
import com.lejingw.apps.myspring3.annotation.bean.TestBean11;
import com.lejingw.apps.myspring3.annotation.bean.TestBean12;
import com.lejingw.apps.myspring3.annotation.bean.TestBean13;
import com.lejingw.apps.myspring3.annotation.bean.TestBean14;
import com.lejingw.apps.myspring3.annotation.bean.TestBean21;
import com.lejingw.apps.myspring3.annotation.bean.TestBean22;
import com.lejingw.apps.myspring3.annotation.bean.TestBean23;
import com.lejingw.apps.myspring3.annotation.bean.TestBean31;
import com.lejingw.apps.myspring3.annotation.bean.TestBean32;
import com.lejingw.apps.myspring3.annotation.bean.TestBean33;
import com.lejingw.apps.myspring3.annotation.bean.TestBean34;
import com.lejingw.apps.myspring3.annotation.bean.TestBean35;
import com.lejingw.apps.myspring3.annotation.bean.TestBean41;
import com.lejingw.apps.myspring3.annotation.bean.TestBean51;
import com.lejingw.apps.myspring3.annotation.bean.TestBean61;

public class DependencyInjectWithAnnotationTest {
    
    private static String configLocation = "classpath:com/lejingw/apps/myspring3/annotation/dependecyInjectWithAnnotation.xml";
