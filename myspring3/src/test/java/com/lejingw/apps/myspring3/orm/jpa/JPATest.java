package com.lejingw.apps.myspring3.orm.jpa;
...
public class JPATest {
	...
	public static void setUpClass() {
		String[] configLocations = new String[] {
				...
				"classpath:com/lejingw/apps/myspring3/orm/jpa/applicationContext-jpa.xml" };
	...
	public void testJpaTemplate() {
		...
		PlatformTransactionManager txManager = ctx
		...
		tansactionTemplate.execute(new TransactionCallback<Void>() {
			...
			public Void doInTransaction(TransactionStatus status) {
				...
				// @Override
				// public Void doInJpa(EntityManager em) throws
