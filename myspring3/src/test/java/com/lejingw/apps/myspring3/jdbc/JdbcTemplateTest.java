...
import com.lejingw.apps.myspring3.jdbc.template.HsqldbLengthFunction;
import com.lejingw.apps.myspring3.jdbc.template.HsqldbTestProcedure;
import com.lejingw.apps.myspring3.jdbc.template.MysqlLengthFunction;
import com.lejingw.apps.myspring3.jdbc.template.dao.IUserDao;
import com.lejingw.apps.myspring3.jdbc.template.model.InsertUserModel;
import com.lejingw.apps.myspring3.jdbc.template.model.UserModel;
import com.lejingw.apps.myspring3.jdbc.template.model.UserModelGenericSqlQuery;
import com.lejingw.apps.myspring3.jdbc.template.model.UserModelMappingSqlQuery;
import com.lejingw.apps.myspring3.jdbc.template.model.UserModelSqlQuery;
...
public class JdbcTemplateTest {
	...
	private int queryForInt(String sql) throws DataAccessException {
	...
	private void insert() {
		...
		Assert.assertEquals(2, queryForInt("select count(*) from test"));
	}

	private void delete() {
		jdbcTemplate.update("delete from test where name=?",
				new Object[] { "name2" });
		Assert.assertEquals(1, queryForInt("select count(*) from test"));
	}
	...
	public void testResultSet4() {
		...
		int count = queryForInt("select count(*) from test");
		Assert.assertEquals(1, count);
	...
	public void testSimpleJdbcTemplate() {
		...
		List<UserModel> result2 = simpleJdbcTemplate.query(selectSql, mapper,
				10, "name5");
		Assert.assertEquals(1, result2.size());
	...
	@Test
	public void testGenericSqlQuery() throws IllegalAccessException,
	...
	public void testStoredProcedure2() {
		...
		mysqlJdbcTemplate.update(dropFunctionSql);
		mysqlJdbcTemplate.update(createFunctionSql);
		StoredProcedure lengthFunction = new MysqlLengthFunction(
				mysqlJdbcTemplate);
		Map<String, Object> outValues = lengthFunction.execute("test");
		Assert.assertEquals(4, outValues.get("result"));
	}
	...
	public void testSimpleJdbcInsert() {
		...
		Assert.assertEquals(5, queryForInt("select count(*) from test"));
	}
	...
	public void testBestPractice() {
		String[] configLocations = new String[] {
				...
				"classpath:com/lejingw/apps/myspring3/jdbc/template/applicationContext-jdbc.xml" };
