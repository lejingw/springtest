package com.lejingw.apps.myspring3.orm.hibernate;
...
import com.lejingw.apps.myspring3.orm.model.UserModel2;
...
public class HibernateTest {
	...
	public static void beforeClass() {
		String[] configLocations = new String[] {
				...
				"classpath:com/lejingw/apps/myspring3/orm/hibernate/applicationContext-hibernate.xml" };
	...
	public void setUP() {
		...
		final String createTableSql = "create memory table test"
				...
				+ "name varchar(100))";
		sessionFactory.openSession().createSQLQuery(createTableSql)
				.executeUpdate();
	}
    @After
    ...
    public void testCURD() {
        String[] configLocations = new String[] {
                "classpath:com/lejingw/apps/myspring3/jdbc/template/applicationContext-resources.xml",
                "classpath:com/lejingw/apps/myspring3/orm/hibernate/applicationContext-hibernate2.xml"};
