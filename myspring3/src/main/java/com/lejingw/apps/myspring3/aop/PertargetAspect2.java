...
@Aspect("pertarget(target(com.lejingw.apps.myspring3.aop.service.IPointcutService))")
public class PertargetAspect2 {
	...
	public void executionTest1(JoinPoint jp) {
		System.out
				.println("============pertarget(target(cn.javass.spring.chapter6.service.IPointcutService)):"
						+ counter++);
	}
