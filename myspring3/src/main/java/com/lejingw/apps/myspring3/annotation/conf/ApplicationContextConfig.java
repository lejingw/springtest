...
import com.lejingw.apps.myspring3.annotation.bean.HelloImpl3;
import com.lejingw.apps.myspring3.annotation.bean.HelloImpl4;
import com.lejingw.apps.myspring3.annotation.bean.HelloImpl5;
import com.lejingw.apps.myspring3.annotation.bean.Printer;

@Configuration("ctxConfig")
// 1、使用@Configuration注解配置类
@ImportResource("classpath:com/lejingw/apps/myspring3/annotation/importResource.xml")
public class ApplicationContextConfig {

	@Bean
	// 2、使用@Bean注解方法Bean对象的方法
